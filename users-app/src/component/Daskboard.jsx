...
function Dashboard() {
  ...
  useEffect(() => {
    axios.get(`https://royer-adames-node-api1-project.herokuapp.com/api/users`)
      .then(resp => {
  ...
  const onSubmitForDeleteById = (data) => {
    setReRun(!reRun)
    axios.delete(`https://royer-adames-node-api1-project.herokuapp.com/api/users/${data.id}`)
      .then(resp => {
        debugger
  ...
  const onSubmitForCreateUser = (createNewUser) => {
    setReRun(!reRun)
    debugger
    axios.post(`https://royer-adames-node-api1-project.herokuapp.com/api/users`, createNewUser)
      .then(resp => {
        debugger
